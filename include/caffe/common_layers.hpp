...
//////////////////////////////////////////////ROIConcat CUHK HUXIAOWEI
template <typename Dtype>
class ROIConcatLayer : public Layer<Dtype> {
 public:
  explicit ROIConcatLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "ROIConcat"; }
  virtual inline int MinBottomBlobs() const { return 4; }  //"roi_normal" "roi_small" "roi_num" "hash_table"
 ...
 protected:
  ...
  int small_roi_;
  int normal_roi_;
  //const Dtype* hash_table_;
};

//////////////////////////////////////////////LabelSplit2 (2 branches) CUHK HUXIAOWEI
template <typename Dtype>
class LabelSplit2Layer : public Layer<Dtype> {
 public:
  explicit LabelSplit2Layer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "LabelSplit2"; }
...
//////////////////////////////////////////////LabelSplit3 (3 branches) CUHK HUXIAOWEI
template <typename Dtype>
class LabelSplit3Layer : public Layer<Dtype> {
 public:
  explicit LabelSplit3Layer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "LabelSplit3"; }
  virtual inline int MinBottomBlobs() const { return 6; }  
  virtual inline int MaxBottomBlobs() const { return 6; }
  virtual inline int ExactNumTopBlobs() const { return 12; }
...
//////////////////////////////////////////////ROIFeatureSplitLayer CUHK HUXIAOWEI
template <typename Dtype>
class ROIFeatureSplitLayer : public Layer<Dtype> {
 public:
  explicit ROIFeatureSplitLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "ROIFeatureSplit"; }
  virtual inline int MinBottomBlobs() const { return 3; }  //"roi_pooled" "roi_num" "hash_table"
