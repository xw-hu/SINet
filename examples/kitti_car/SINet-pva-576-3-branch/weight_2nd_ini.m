...
net2.layers('fc6_middle').params(1).set_data(fc6_1);
net2.layers('fc6_middle').params(2).set_data(fc6_2);

net2.layers('fc6/bn_middle').params(1).set_data(net1.layers('fc6/bn').params(1).get_data()); 
net2.layers('fc6/bn_middle').params(2).set_data(net1.layers('fc6/bn').params(2).get_data()); 
net2.layers('fc6/bn_middle').params(3).set_data(net1.layers('fc6/bn').params(3).get_data()); 
net2.layers('fc6/scale_middle').params(1).set_data(net1.layers('fc6/scale').params(1).get_data()); 
net2.layers('fc6/scale_middle').params(2).set_data(net1.layers('fc6/scale').params(2).get_data()); 
