...
weight2='SINet_lsvh_train_1st_iter_10000.caffemodel';
...
fc6_11=net2.layers('fc6_large').params(1).get_data();
fc6_22=net2.layers('fc6_large').params(2).get_data();

fc6cut_1=fc6_1(1:13824,:);


net2.layers('fc6_small').params(1).set_data(fc6cut_1);
...
net2.layers('fc6_large').params(1).set_data(fc6cut_1);
...
net2.save('SINet_lsvh_train_2nd_iter_initial.caffemodel');
