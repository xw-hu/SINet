...
const int32_t MIN_HEIGHT[4] = {66, 66, 66, 66};     // minimum height for evaluated groundtruth/detections
//const int32_t MAX_HEIGHT[4] = {54, 54, 54, 54};     // maximum height for evaluated groundtruth/detections
